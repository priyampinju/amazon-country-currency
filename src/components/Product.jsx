...
const Product = ({ selectedCurrency }) => {
  const prices = {
    INR: 2700,
    USD: 35,
    GBP: 27,
      ...
      <div className="w-2/5 mt-20">
        ...
        <h6 className="mt-3">
          ...
          <span className="line-through">
            {selectedCurrency} {price * 1.85}
          </span>
        </h6>
        <h6>Inclusive of all taxes</h6>
        <p>
          <span className="font-semibold">EMI</span> starts at{" "}
          {selectedCurrency} {(price / 20).toFixed(2)}. No Cost EMI available{" "}
          <span className="text-linkblue">EMI options</span>
        </p>
      </div>
      <div className="w-1/6 mt-20 px-10 border border-gray-200 mx-6 rounded-lg py-5">
